...
applies a color filter to keep only the red objects, applies various smoothing techniques, 
...
while True:
    ...
    smoothed = cv2.filter2D(res, -1, kernel)  # though smooth it produces blurred effect
